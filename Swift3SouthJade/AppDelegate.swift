...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBarItem.appearance().setTitleTextAttributes([NSForegroundColorAttributeName:UIColor(red: 0/255.0, green: 194/255.0, blue: 113/255.0, alpha: 1)], for: .selected)
        ...
        for VC in rootVC.viewControllers! {
            ...
            // 要把修改过后的值赋给你想要修改的对象
            navVC.tabBarItem.selectedImage = navVC.tabBarItem.selectedImage?.withRenderingMode(.alwaysOriginal)
